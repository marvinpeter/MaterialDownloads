 ...
 */
function getProgressIcon(progress: number): chrome.browserAction.TabIconDetails {
    const w = progress * 38;
 ...
 */
function getIcon(): chrome.browserAction.TabIconDetails {
    ctx.clearRect(0, 0, 38, 38);
 ...
 */
export async function updateColor(): Promise<void> {
 ...
 */
export function setIcon(progress?: number): void {
 ...
 */
export function setBadge(count: number = 0): void {
